...
exports.fixCurrentFile = fixCurrentFile;
...
async function fixCurrentFile() {
    ...
    const payload = await (0, editorContext_1.buildEditorPayload)("fix_file", `Fix the code in ${backendPath}`, { runValidation: true, generateTests: true });
    await vscode.window.withProgress({
        location: vscode.ProgressLocation.Notification,
        title: "Agent is fixing the current file",
        cancellable: false
    }, async () => {
